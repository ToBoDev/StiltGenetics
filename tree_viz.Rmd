...
(ggtree(spades.tree, layout = "roundrect") +
  geom_text(aes(label=label, hjust = -0.2)) +
    geom_text(aes(label=node)))  %<+% year.metadata +
...
inward.circle <- ggtree(spades.tree) %>% 
    ggtree::rotate(86) %>% 
    ggtree::rotate(142) %>% 
    ggtree::rotate(141) + #geom_text(aes(label=node)) +
...
#triads
  ...
  geom_taxalink(aPOs[6,1], aPOs[6,2], color = po.col, linetype = po.lt, linewidth = 1, curvature = curvature.var, offset = offset.var, hratio = hratio) +
  geom_taxalink(aPOs[7,1], aPOs[7,2], color = po.col, linetype = po.lt, linewidth = 1, curvature = curvature.var, offset = offset.var, hratio = hratio) +
  geom_taxalink(aPOs[8,1], aPOs[8,2], color = po.col, linetype = po.lt, linewidth = 1, curvature = curvature.var, offset = offset.var, hratio = hratio) +
...
consensus.plot <- inward.circle  %<+% year.metadata +
  ...
  geom_taxalink(bPOs[3,1], bPOs[3,2], color = po.col2, alpha = 1, linetype = beh.lt, curvature = curvature.var, offset = offset.var, hratio = hratio) +
  ...
  geom_taxalink(aPOs[6,1], aPOs[6,2], color = po.col2, alpha = 1, linetype = app.lt, curvature = curvature.var, offset = offset.var, hratio = hratio) + 
...
#dryads HS+
  ...
  geom_taxalink(bHSs [4,1], bHSs [4,2], color = hs.col2, alpha = 1, linetype = hs.lt, curvature = curvature.var, offset = offset.var, hratio = hratio) +
  ...
  geom_taxalink(aHSs [6,1], aHSs [6,2], color = hs.col2, alpha = 1, linetype = hs.lt, curvature = curvature.var, offset = offset.var, hratio = hratio) + 
...
#dryads FS
  ...
  geom_taxalink(bFSs [11,1], bFSs [11,2], color = fs.col2, alpha = 1, linetype = fs.lt2, linewidth = 1, curvature = curvature.var, offset = offset.var, hratio = hratio) +
  ...
  geom_taxalink(bFSs [14,1], bFSs [14,2], color = fs.col2, alpha = 1, linetype = fs.lt2, linewidth = 1, curvature = curvature.var, offset = offset.var, hratio = hratio) +
  ...
  geom_taxalink(bFSs [21,1], bFSs [21,2], color = fs.col2, alpha = 1, linetype = fs.lt2, linewidth = 1, curvature = curvature.var, offset = offset.var, hratio = hratio) +
  ...
  geom_taxalink(bFSs [27,1], bFSs [27,2], color = fs.col2, alpha = 1, linetype = fs.lt2, linewidth = 1, curvature = curvature.var, offset = offset.var, hratio = hratio) +
  ...
  geom_taxalink(aFSs [6,1], aFSs [6,2], color = fs.col2, alpha = 1, linetype = fs.lt2, linewidth = 1, curvature = curvature.var, offset = offset.var, hratio = hratio) +
